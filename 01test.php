    ...
    <div class="wrapper">
                    ...
                    <ul class="menu">
                      <li>
                        ...
                        <a href="#">
                          ...
                          <p>¿Por qué no comprar un producto?</p>
                        </a>
                      </li>
                      <!-- end message -->
                      <li>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <i class="fa fa-warning text-yellow"></i> Muy largo
                          descripción aquí que puede no encajar en la página y
                          puede causar problemas de diseño
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-users text-red"></i> 5 nuevos miembros
                          unido
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="#">
                          <i class="fa fa-user text-red"></i> cambiaste tu
                          nombre de usuario
                        </a>
                      </li>
                    </ul>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li>
              <a href="#"><i class="fa fa-dashboard"></i> Hogar</a>
            </li>
          ...
          <div class="tab-pane" id="control-sidebar-settings-tab">
            <form method="post">
              ...
              <div class="form-group">
                ...
                Informar sobre el uso del panel
                  <input type="checkbox" class="pull-right" checked />
                </label>

                <p>Alguna información sobre esta opción de configuración general</p>
              </div>
              <!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <p>Hay otros conjuntos de opciones disponibles.</p>
              </div>
              <!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <p>Permitir al usuario mostrar su nombre en publicaciones de blog.</p>
              </div>
              <!-- /.form-group -->
